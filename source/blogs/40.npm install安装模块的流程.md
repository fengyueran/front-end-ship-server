...
测试的包发布后，为了能够更加细致的了解安装流程，需要下载[npm cli 的源码](https://github.com/npm/cli)来执行 npm install。下载完成后在我们的测试目录(test)引用 cli 仓库的脚本执行 npm install。

```
$ node /Users/xinghunm/framework/cli/bin/npm-cli.js i xinghunm-a
```
...
以安装 xinghunm-a 为例，执行如下命令：

```
$ npm cache clean -f
$ node --inspect-brk  /Users/xinghunm/xinghun/MyHouse/framework/cli/bin/npm-cli.js i xinghunm-a  --timing=true
```
...
```js
{
  ...
  children: [
   {
      name: 'xinghunm-a',
      path: '/Users/xinghunm/xinghun/MyHouse/test/npm/node_modules/xinghunm-a',
      realpath: '/Users/xinghunm/xinghun/MyHouse/test/npm/node_modules/xinghunm-a',
      error: null,
      id: 1,
      package: [Object],
      parent: [Circular],
    ...
    {
      name: 'xinghunm-b',
      path: '/Users/xinghunm/xinghun/MyHouse/test/npm/node_modules/xinghunm-b',
      realpath: '/Users/xinghunm/xinghun/MyHouse/test/npm/node_modules/xinghunm-b',
      error: null,
      id: 2,
      package: [Object],
      parent: [Circular],
   ...
   {
      name: 'xinghunm-c',
      path: '/Users/xinghunm/xinghun/MyHouse/test/npm/node_modules/xinghunm-c',
      realpath: '/Users/xinghunm/xinghun/MyHouse/test/npm/node_modules/xinghunm-c',
      error: null,
      id: 3,
      package: [Object],
      parent: [Circular],
   ...
   {
      name: 'xinghunm-d',
      path: '/Users/xinghunm/xinghun/MyHouse/test/npm/node_modules/xinghunm-d',
      realpath: '/Users/xinghunm/xinghun/MyHouse/test/npm/node_modules/xinghunm-d',
      error: null,
      id: 4,
      package: [Object],
      parent: [Circular],
